...
def create_varying_params_all_mnli_to_rte(
    ...
    for grouping_key, models in grouping_to_params.items():
        ...
        rte_models = [mtm for mtm in models if mtm.task == "rte"]
        mnli_models = [mtm for mtm in models if mtm.task == "mnli"]
        for rte_model in rte_models:
...
@experiment.experiment(
    uuid="f5b81fc4fb0f4744957a795e6fcfba81",
    ...
    varying_params=functools.partial(
        ...
        rte_fisher_exp=fisher_bert_base.GlueRegs_Fisher_Rte_Iso_0_0003_AllCkpt,
...
class MergeEachRteWithEachMnli_Iso_0_0003_GlueRegs(object):
