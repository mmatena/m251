...
python3 m251/exp_groups/paper/ablations/reg_intermediate2/launch/launch_finetune.py
...
from m251.exp_groups.paper.ablations.reg_intermediate2 import finetune


EXP = finetune.Finetune_Rte
# EXP = finetune.Finetune_Mnli
