...
python3 m251/exp_groups/paper/ablations/reg_intermediate2/launch/launch_record_distances.py
...
EXP = record_distances.Finetune_Rte
# EXP = record_distances.Finetune_Mnli
