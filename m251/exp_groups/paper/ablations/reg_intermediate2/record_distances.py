...
@experiment.experiment(
    uuid="256220acc89840abae473eca135f7bf7",
    group=PaperExpGroup,
    ...
    bindings=[
        ...
        scopes.ArgNameBindingSpec(
            "callbacks", distance_callback.distance_saver_callback
        ),
...
@experiment.experiment(
    uuid="d4be8b0d07614e939544b10d5239263e",
    group=PaperExpGroup,
    params_cls=FinetuneParams,
    executable_cls=fitting.training_run,
    varying_params=[
...
class Finetune_Mnli(ExperimentAbc):
    pass
