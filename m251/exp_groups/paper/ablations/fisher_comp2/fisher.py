...
from ...nlp.intermediate_hf.finetune import GlueFinetune_BertBase
...
@experiment.experiment(
    uuid="3440171ebdb04f0cbb60df794945e83e",
    group=PaperExpGroup,
    ...
    varying_params=[
        {
            "task": "mnli",
            "pretrained_model": defs.TASK_TO_CKPT_BERT_BASE["mnli"],
            "num_examples": num_examples,
        }
        for num_examples in TASK_TO_EXAMPLE_COUNTS["mnli"]
    ],
    fixed_params={
        "batch_size": 4,
        "sequence_length": 64,
...
class Fisher_BertBase_Mnli(ExperimentAbc):
    pass
...
@experiment.experiment(
    uuid="cc483af93ec54aa680d51b75e1ab9e41",
    group=PaperExpGroup,
    ...
    varying_params=functools.partial(
        ...
        task="rte",
        num_examples_list=TASK_TO_EXAMPLE_COUNTS["rte"],
    ),
    fixed_params={
        "batch_size": 4,
        "sequence_length": 64,
...
class Fisher_BertBase_Rte(ExperimentAbc):
    pass
