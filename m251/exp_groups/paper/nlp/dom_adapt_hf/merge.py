...
from .finetune import Finetune_LowResource, Finetune_LowResource_FOR_REAL
from .fisher import FisherComputation_TargetTask, FisherComputation_TargetTask_FOR_REAL
...
@experiment.experiment(
    uuid="985b2da129e648f18ee367be2b02ab7f",
    group=PaperExpGroup,
...
class Merge_MlmS2orc_Normalized(ExperimentAbc):
    # NOTE: Used 131072 fisher examples.
    pass


@experiment.experiment(
    uuid="dad52e0768ca4fc38ee706d943ef6520",
    group=PaperExpGroup,
    params_cls=MergeParams,
    executable_cls=merging_execs.merge_and_evaluate_from_checkpoints,
    varying_params=functools.partial(
...
class Merge_MlmS2orc_Normalized_Mlm4096(ExperimentAbc):
    pass


@experiment.experiment(
    uuid="73d2c63e26fd4c93ad81eba9f452c581",
    group=PaperExpGroup,
    params_cls=MergeParams,
    executable_cls=merging_execs.merge_and_evaluate_from_checkpoints,
    varying_params=functools.partial(
        ...
        target_fisher_exp=FisherComputation_TargetTask_FOR_REAL,
        donor_fisher_exp=FisherComputation_MlmS2orc,
        mlm_fisher_examples=131072,
    ),
    fixed_params={
...
class Merge_MlmS2orc_Normalized_131072_FOR_REAL(ExperimentAbc):
    # NOTE: Used 131072 fisher examples.
    pass
