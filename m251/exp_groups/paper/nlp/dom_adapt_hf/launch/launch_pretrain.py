...
python3 m251/exp_groups/paper/nlp/dom_adapt_hf/launch/launch_pretrain.py
...
from m251.exp_groups.paper.nlp.dom_adapt_hf import pretrain


# EXP = pretrain.Pretrain_32768
# EXP = pretrain.Pretrain_More
# EXP = pretrain.Pretrain_FromDapt_32768
EXP = pretrain.Pretrain_32768_NoReg
