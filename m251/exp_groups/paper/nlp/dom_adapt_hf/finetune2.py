...
@experiment.experiment(
    uuid="df7a48aa86154a15bbc970ee47ea5a45",
    group=PaperExpGroup,
...
class Finetune_DAPT_LowResource(ExperimentAbc):
    pass


@experiment.experiment(
    uuid="eb4e06b4479749b398c99edd20b2e5b4",
    group=PaperExpGroup,
    params_cls=FinetuneParams,
    executable_cls=fitting.training_run,
    varying_params=[
...
class Finetune_ROBERTA_LowResource(ExperimentAbc):
    pass


@experiment.experiment(
    uuid="d2760b444bde4af390bbe84ff3725530",
    group=PaperExpGroup,
    params_cls=FinetuneParams,
    executable_cls=fitting.training_run,
    varying_params=[
    ...
    bindings=[
        ...
        scopes.ArgNameBindingSpec("use_roberta_head", True),
        #
        scopes.ArgNameBindingSpec("freeze_body", True),
    ],
)
class Finetune_DAPT_LowResource_HeadOnly(ExperimentAbc):
    pass
