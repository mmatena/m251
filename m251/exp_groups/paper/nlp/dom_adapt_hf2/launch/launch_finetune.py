...
python3 m251/exp_groups/paper/nlp/dom_adapt_hf2/launch/launch_finetune.py
...
from m251.exp_groups.paper.nlp.dom_adapt_hf2 import finetune


# EXP = finetune.Finetune_Cs
EXP = finetune.Finetune_BioMed
