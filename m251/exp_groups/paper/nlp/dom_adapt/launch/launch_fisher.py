...
python3 m251/exp_groups/paper/nlp/dom_adapt/launch/launch_fisher.py
...
# EXP = fisher.FisherComputation_MlmTargetTask
# EXP = fisher.FisherComputation_TargetTask
EXP = fisher.FisherComputation_MlmS2orc
