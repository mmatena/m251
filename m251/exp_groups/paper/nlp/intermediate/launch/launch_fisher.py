...
python3 m251/exp_groups/paper/nlp/intermediate/launch/launch_fisher.py
...
# EXP = fisher.FisherComputation_LastCkpt
# EXP = fisher.FisherComputation_AltCkpts
EXP = fisher.FisherComputation_LowRegStrength
