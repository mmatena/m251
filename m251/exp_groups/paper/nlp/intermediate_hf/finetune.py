...
@experiment.experiment(
    uuid="8d3328c5d790416f9001a912e9ab3937",
    varying_params=[
...
#
#
# NOTE: I'LL NEED A WAY TO NOT USE THE MNLI HEAD HERE. ADD SOME KWARG LIKE
# IGNORE_HEAD OR USE_HEAD OR SOMETHING!!!
#
#
@experiment.experiment(
    uuid="cad1e501c944437a9e21b3b2198cd705",
    varying_params=[
        get_varying_param(task, i, defs.BERT_BASE_MNLI_CKPT)
        for task in defs.TASKS_FINETUNED_FROM_MNLI
        for i in range(defs.LOW_RESOURCE_TRIALS)
    ],
    **COMMON_KWARGS,
)
