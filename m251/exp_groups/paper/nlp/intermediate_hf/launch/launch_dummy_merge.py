...
python3 m251/exp_groups/paper/nlp/intermediate_hf/launch/launch_dummy_merge.py
...
from m251.exp_groups.paper.nlp.intermediate_hf import dummy_merge


EXP = dummy_merge.Merge_BertBase_Rte_SquadDonor_4096
...
entrypoint.worker_run(**execution_items[4].worker_run_kwargs)


"""

import numpy as np
q = [66.78700361010831, 66.4259927797834, 63.898916967509024, 64.62093862815884, 64.98194945848375]
print(np.mean(q))
print(np.std(q))
