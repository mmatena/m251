...
# EXP = merge.Merge_BertBase_RteHoldout_LastCkpt
# EXP = merge.Merge_BertBase_RteHoldout_LastCkpt2
# EXP = merge.Merge_BertBase_RteHoldout_LastCkpt50
# EXP = merge.DummyMerge_BertBase_Pairs
# EXP = merge.DummyMerge_BertBaseFromMnli_Pairs

execution_items = []
EXP = merge.DummyMerge_BertBaseFromMnli_SquadDonor_4096
execution_items.extend(EXP.create_all_execution_items())
EXP = merge.DummyMerge_BertBase_SquadDonor_4096
execution_items.extend(EXP.create_all_execution_items())
EXP = merge.DummyMerge_BertBase_HighResource_SquadDonor_4096
execution_items.extend(EXP.create_all_execution_items())
