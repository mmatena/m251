...
from .fisher import FisherComputation_LastCkpt
...
@experiment.experiment(
    ...
    bindings=[
        ...
        scopes.ArgNameBindingSpec("multitask_merge", True),
        #
