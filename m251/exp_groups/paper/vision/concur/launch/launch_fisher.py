...
python3 m251/exp_groups/paper/vision/concur/launch/launch_fisher.py
...
from m251.exp_groups.paper.vision.concur import fisher


# EXP = fisher.FisherComputation_Subsets_LastCkpt
EXP = fisher.FisherComputation_Subsets_LastCkpt_AllVars
