...
python3 m251/exp_groups/paper/vision/concur/launch/launch_merge.py
...
from m251.exp_groups.paper.vision.concur import merge


# EXP = merge.Merge_Subsets_LastCkpt
EXP = merge.Merge_Subsets_LastCkpt_AllVars
